...
class CircleListItemView extends StatelessWidget {
  const CircleListItemView({required this.circle, Key? key}) : super(key: key);
  final Circle circle;
    ...
    return GestureDetector(
      onTap: () async {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: ((context) => CircleDetailPage(circle: circle)),
          ),
        );
      },
      child: Padding(
